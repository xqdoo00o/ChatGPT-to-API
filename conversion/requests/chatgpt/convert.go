...
func ConvertAPIRequest(api_request official_types.APIRequest, secret *tokens.Secret, requireArk bool, dx string, proxy string) chatgpt_types.ChatGPTRequest {
	...
	for _, api_message := range api_request.Messages {
		...
		chatgpt_request.AddMessage(api_message.Role, api_message.Content, ifMultimodel, secret, proxy)
	}
